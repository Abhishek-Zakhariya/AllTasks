...
//     try {
//         let tbl = document.querySelector('#tbl_edu');
//         let tr = `
//        <tr class="edu_data">
...
//     let tbl = document.querySelector('#tbl_edu');
//     let tr = document.getElementsByClassName('edu_data')
...
// function addExp() {
//     let tbl = document.getElementById('tbl_exp');
// }
...
async function showtab(n) {
    ...
    // var total_page = tab.length;

    tab[counter].style.display = 'none';
    counter = counter + n;
    tab[counter].style.display = 'block';
